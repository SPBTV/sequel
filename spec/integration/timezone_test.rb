...
describe "Sequel timezone support" do
  ...
  cspecify "should support using UTC for database storage and local time for the application", [:tinytds], [:do, :mysql], [:do, :postgres], [:oracle], :vertica do
  ...
  cspecify "should support using local time for database storage and UTC for the application", [:tinytds], [:do, :mysql], [:do, :postgres], [:oracle], :vertica do
  ...
  cspecify "should support using UTC for both database storage and for application", [:do, :mysql], [:do, :postgres], [:oracle], :vertica do
  ...
  cspecify "should support using local time for both database storage and for application", [:do, :postgres], [:oracle], :vertica do
